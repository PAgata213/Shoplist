...
namespace ShopList.Client.Interfaces
{
  public interface IAPIHelper
  {
    ...
    Task<Response<TResponse>> GetAsync<TResponse>(string apiEndpoint, params int[] id) where TResponse : class;
    ...
    Task<Response<TResponse>> PostAsync<TResponse>(string apiEndpoint, params int[] id) where TResponse : class;
