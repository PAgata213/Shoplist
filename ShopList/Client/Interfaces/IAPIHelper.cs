...
namespace ShopList.Client.Interfaces
{
  public interface IAPIHelper
  {
    ...
    Task<Response<TResponse>> GetAsync<TResponse>(string apiEndpoint, Dictionary<string, object> parameters) where TResponse : class;
    ...
    Task<Response<TResponse>> PostAsync<TResponse>(string apiEndpoint, Dictionary<string, object> parameters) where TResponse : class;
