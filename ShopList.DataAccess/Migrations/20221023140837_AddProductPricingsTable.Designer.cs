...
namespace ShopList.DataAccess.Migrations
{
    ...
    [Migration("20221023140837_AddProductPricingsTable")]
    partial class AddProductPricingsTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ListOfProductsToBuyProductToBuy", b =>
                {
                    ...
                    b.HasKey("ListsOfProductsToBuyId", "ProductsToBuyId");
            ...
            modelBuilder.Entity("ShopList.Shared.DataModels.Authentication.IdentityUserModel", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ShopList.Shared.DataModels.ShopList.ListOfProductsToBuy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ListsOfProductsToBuy");
                });
            ...
            modelBuilder.Entity("ShopList.Shared.DataModels.ShopList.ProductPricing", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShopList.Shared.DataModels.ShopList.Shop", b =>
                {
                    ...
                    b.HasIndex("ShopBrandId");

                    b.ToTable("Shops");
                });

            modelBuilder.Entity("ShopList.Shared.DataModels.ShopList.ShopBrand", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("ShopBrandName")
                        .IsRequired()
                        .HasMaxLength(100)
            ...
            modelBuilder.Entity("ListOfProductsToBuyProductToBuy", b =>
                {
                    b.HasOne("ShopList.Shared.DataModels.ShopList.ListOfProductsToBuy", null)
                        .WithMany()
                        .HasForeignKey("ListsOfProductsToBuyId")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ShopList.Shared.DataModels.Authentication.IdentityUserModel", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ShopList.Shared.DataModels.ShopList.ProductPricing", b =>
                {
                    ...
                    b.HasOne("ShopList.Shared.DataModels.ShopList.Shop", "Shop")
                        .WithMany("ProductPricings")
